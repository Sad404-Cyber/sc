...
// Stalk
        case 'stalkig':
            ...
            axios.get(`https://api.lolhuman.xyz/api/stalkig/${args[0]}?apikey=sayajiro`).then(({ data }) => {
                ...
                alpha.sendMessage(from, { image: { url: data.result.photo_profile }, caption })
            })
            break
        case 'stalkgithub':
            ...
            axios.get(`https://api.lolhuman.xyz/api/github/${args[0]}?apikey=sayajiro`).then(({ data }) => {
                ...
                caption += `Following : ${data.result.following}\n`
                caption += `Bio : ${data.result.bio}`
                alpha.sendMessage(from, { image: { url: data.result.avatar }, caption })
            })
            break
        case 'stalktwitter':
            ...
            axios.get(`https://api.lolhuman.xyz/api/twitter/${args[0]}?apikey=sayajiro`).then(({ data }) => {
                ...
                alpha.sendMessage(from, { image: { url: data.result.profile_picture }, caption })
            })
            break
        case 'stalktiktok':
            ...
            axios.get(`https://api.lolhuman.xyz/api/stalktiktok/${args[0]}?apikey=sayajiro`).then(({ data }) => {
                ...
                caption += `Bio : ${data.result.bio}\n`
                alpha.sendMessage(from, { image: { url: data.result.user_picture }, caption })
            })
            break
            case 'anime':{
            ...
            break
				case 'menu':{
					if(typemenu == 'templateLocation'){
						await alpha.send5ButLoc(from, lang.menunya(salam, pushname, botname) , `© ${ownername}`,pp_bot, [{"urlButton": {"displayText": "Instagram Creator","url": `${instagram}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "List Command","id": 'allmenu'}}] )
							}
						if(typemenu == 'templateTenor'){
							alpha.send5ButGif(from, lang.menunya(salam, pushname, botname) , `© ${ownername}`,pp_bot, [{"urlButton": {"displayText": "Instagram Creator","url": `${instagram}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "List Command","id": 'allmenu'}}] , {quoted: m})
						 }
						if(typemenu == 'katalog'){
...
case 'ytplay':
            ...
            axios
                .get(`https://api.lolhuman.xyz/api/ytsearch?apikey=sayajiro&query=${full_args}`)
                .then(({ data }) => {
        ...
        case 'ytmp3':
            ...
            axios
                .get(`https://api.lolhuman.xyz/api/ytaudio2?apikey=sayajiro&url=${args[0]}`)
                .then(({ data }) => {
                    var caption = `❖ Title    : *${data.result.title}*\n`
                    caption += `❖ Size     : *${data.result.size}*`
                    alpha.sendMessage(from, { image: { url: data.result.thumbnail }, caption }).then(() => {
        ...
        case 'spotify':
            ...
            axios.get(`https://api.lolhuman.xyz/api/spotify?apikey=sayajiro&url=${args[0]}`).then(({ data }) => {
                var caption = `Title : ${data.result.title}\n`
        ...
        case 'spotifysearch':
            if (args.length == 0) return reply(`Example: ${prefix + command} Melukis Senja`)
            axios.get(`https://api.lolhuman.xyz/api/spotifysearch?apikey=sayajiro&query=${full_args}`).then(({ data }) => {
                var text = ''
                for (var x of data.result) {
                    text += `Title : ${x.title}\n`
        ...
        case 'jooxplay':
            if (args.length == 0) return reply(`Example: ${prefix + command} Melukis Senja`)
            axios.get(`https://api.lolhuman.xyz/api/jooxplay?apikey=sayajiro&query=${full_args}`).then(({ data }) => {
        ...
        case 'zippyshare':
            ...
            axios.get(`https://api.lolhuman.xyz/api/zippyshare?apikey=sayajiro&url=${args[0]}`).then(({ data }) => {
